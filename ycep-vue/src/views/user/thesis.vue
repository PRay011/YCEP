          ...
          <el-scrollbar height="600px">
            ...
            <div class="paper" v-if="currentNav == 2">
              ...
              <el-form>
                ...
                <el-input type="textarea" v-model="thesis.content[0]" :autosize="{ minRows:18 }"></el-input>
              </el-form>
            </div>
            <div class="paper" v-if="currentNav == 3">
              ...
              <el-form>
                ...
                <el-input type="textarea" v-model="thesis.content[1]" :autosize="{ minRows:18 }"></el-input>
              </el-form>
            </div>
            <div class="paper" v-if="currentNav == 4">
              ...
              <el-form>
                ...
                <el-input type="textarea" v-model="thesis.content[2]" :autosize="{ minRows:18 }"></el-input>
              </el-form>
            </div>
            <div class="paper" v-if="currentNav == 5">
              ...
              <el-form>
                ...
                <el-input type="textarea" v-model="thesis.content[3]" :autosize="{ minRows:18 }"></el-input>
              </el-form>
            </div>
...
import {getBasicThesis, getKeywordsAndBrief} from "@/api/user/thesis";
...
export default defineComponent({
  ...
  methods: {
    ...
    showBasicThesis() {
      let that = this;
      getBasicThesis(that.id).then(res => {
    ...
    showKeywordAndBrief() {
      ...
      getKeywordsAndBrief(that.thesis.id,that.thesis.content).then(res => {
